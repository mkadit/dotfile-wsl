...

  {
    ...
    opts = {
      options = {
        ...
        -- You can add other bufferline options here if you want to customize it further
        -- For example:
   ...
   .;:;+;:+:;::::::;;:::........ :;;;;: .;;;: .....:;::.;::: :+:;:                                  
      ..;;:;;::;::::+:::;:.::                    :;;;;x+::;:;;;;;                                   
        ...
        keys = {
          ...
          { icon = " ", key = "c", desc = "Config", action = ":Telescope config_pick" },
          { icon = " ", key = "b", desc = "Notes", action = ":e ~/Documents/Notes/notes/Main.md", },
